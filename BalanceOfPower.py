...
def _(mo):
    ...
    - Start by adjusting the weight and height sliders on the right to match your stature (turn phone sideways if viewing on a mobile device). These are used to estmate your body surface area, which relates to heat loss.
