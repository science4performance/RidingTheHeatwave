...
def _(mo):
    ...
    - Start by adjusting the weight and height sliders on the right to match your stature. These are used to estimate your body surface area, which relates to heat loss.
